...
void Transform2D::rotateMatrix(float u)
{
	...
	RotateMatrix[0][0] = cos(u*PI/180);		RotateMatrix[0][1] = - sin(u*PI/180);	RotateMatrix[0][2] = 0;
	RotateMatrix[1][0] = sin(u*PI/180);		RotateMatrix[1][1] = cos(u*PI/180);		RotateMatrix[1][2] = 0;
